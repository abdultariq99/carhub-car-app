...
export const Hero = () => {
  return (
    <section className="h-full w-full flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="w-full h-full md:w-1/2 flex items-start justify-end flex-row md:flex-col relative">
